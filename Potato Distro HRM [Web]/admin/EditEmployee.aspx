<%@ Page Title="Potato Distro HRM - Edit Employee" Language="C#" MasterPageFile="~/template/Admin.Master" AutoEventWireup="true" CodeBehind="EditEmployee.aspx.cs" Inherits="Potato_Distro_HRM__Web_.EditEmployee" UnobtrusiveValidationMode="None"%>
        ...
        <div class="form-row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="dropdownDept" CssClass="form-control" runat="server" DataSourceID="DepartmentSource" DataTextField="name" DataValueField="id"></asp:DropDownList><br />
                </div>
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="dropdownSuper" CssClass="form-control" runat="server" DataSourceID="SupervisorSource" DataTextField="name" DataValueField="id" AppendDataBoundItems="true">
                        <asp:ListItem Text="[Select a supervisor]" Value="" />
                    </asp:DropDownList>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ControlToValidate="startDate" ForeColor="Red" ErrorMessage="*Required" runat="server"/>
                </div>
                <div class="form-group">
                    <asp:Label CssClass="bold" runat="server">End date</asp:Label>
                    <input id="endDate" type="text" runat="server" class="form-control"/>
                </div>
                <div class="form-group">
                    <asp:Label runat="server" CssClass="bold">Status</asp:Label>
                    <asp:DropDownList CssClass="form-control" runat="server" ID="empStatus">
                        <asp:ListItem Text="In Service" Value="1" />
                        <asp:ListItem Text="Not In Service" Value="0" />
                    </asp:DropDownList>    
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            $(function () {
                ...
                $("#<%=empStatus.ClientID%>").change(function () {
                    var status = $(this).val();
                    if (status === "0") {
                        $("#<%=endDate.ClientID%>").datepicker("option", "disabled", false);
                        $("#<%=endDate.ClientID%>").datepicker("setDate", "today");
                    } else {
                        $("#<%=endDate.ClientID%>").datepicker("option", "disabled", true);
