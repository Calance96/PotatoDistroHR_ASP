<%@ Page Title="" Language="C#" MasterPageFile="~/template/Admin.Master" AutoEventWireup="true" CodeBehind="ManageDepartmentEmployee.aspx.cs" Inherits="Potato_Distro_HRM__Web_.department.ManageDepartmentEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="text-center">
        <asp:Button ID="btnAdd" runat="server" Text="Add Employee" CssClass="btn btn-info btn-lg" OnClick="btnAdd_Click"/>
    ...
    <asp:Panel ID="zeroResultPanel" runat="server" CssClass="text-center" Visible="false"><span class="h4 text-secondary">No employee found.</span></asp:Panel>
    <div id="gridview">
        <asp:GridView ID="employeeGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" DataKeyNames="id"  OnDataBound="EmployeeGridView_DataBound" AllowSorting="True" OnSorting="employeeGridView_Sorting">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:LinkButton ID="deleteBtn" runat="server" CssClass="btn btn-danger btn-sm" CommandArgument='<%#Eval("id") %>' OnClientClick="return confirm('Are you sure you want to remove this employee from this department?')" OnCommand="RemoveEmployee">
