<%@ Page Title="" Language="C#" MasterPageFile="~/template/Admin.Master" AutoEventWireup="true" CodeBehind="EditDepartment.aspx.cs" Inherits="Potato_Distro_HRM__Web_.department.EditDepartment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="add-form">
        ...
        <div class="form-row">
            <div class="col-md-6">
                <div class="form-group">
                    <asp:Button ID="btnManageDeptEmployee" runat="server" Text="Manage Department Employee" CssClass="btn btn-info btn-lg" OnClick="btnManageDeptEmployee_Click"/>
                </div>
            </div>
        </div>
        <br /><hr />
